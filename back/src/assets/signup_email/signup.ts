...
import { upperCaseFirst } from '../../constants'
														...
														<tr>
															<td class="pad"
																...
																<div align="center" class="alignment"
																	...
																	<div class="fullWidth" style="max-width: 600px;"><a
											...
											<tr>
												<td class="column column-1"
													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad"
																style="padding-bottom:20px;padding-right:60px;width:100%;padding-left:0px;">
																<div align="center" class="alignment"
																	style="line-height:10px">
																	<div class="fullWidth" style="max-width: 330px;"><a
																			href="https://www.example.com"
																			style="outline:none" tabindex="-1"
								...
								<td>
									<table align="center" border="0" cellpadding="0" cellspacing="0"
										...
										<tbody>
											<tr>
												<td class="column column-1"
													style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 25px; padding-top: 15px; vertical-align: middle; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;"
													width="100%">
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad"
																...
																<h1
																	...
																	<span class="tinyMce-placeholder">hey
																		<strong>${name}</strong>,</span></h1>
															</td>
														</tr>
													</table>
													<table border="0" cellpadding="0" cellspacing="0"
								...
								<td>
									<table align="center" border="0" cellpadding="0" cellspacing="0"
										...
										<tbody>
											<tr>
												<td class="column column-1"
													style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 25px; padding-top: 30px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;"
													width="100%">
													<table border="0" cellpadding="0" cellspacing="0"
														class="image_block block-1" role="presentation"
														style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;"
														...
														<tr>
															<td class="pad"
																...
																<div
																	...
																	<p style="margin: 0;">You can unsubscribe <a
														...
														<tr>
															<td class="pad"
																...
																<div
																	...
																	<p style="margin: 0;">© FindYourCompanion.ca 2024
																	</p>
																</div>
															</td>
														</tr>
